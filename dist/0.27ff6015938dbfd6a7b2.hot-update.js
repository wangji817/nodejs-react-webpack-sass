    ...
    _createClass(Home, [{
        ...
        value: function componentDidMount() {
            ...
            $(window).scroll(function () {
                ...
                if (scrollTop > 0 && scrollTop >= navOne - clientH / 4 && scrollTop < navTwo) {
                    _this.setState({
                        navIndex: 1
                    });
                } else if (scrollTop >= navTwo - clientH / 4 && scrollTop < navThree) {
                    _this.setState({
                        navIndex: 2
                    });
                } else if (scrollTop >= navThree - clientH / 4 && scrollTop < navFour) {
                    _this.setState({
                        navIndex: 3
                    });
                } else if (scrollTop >= navFour - clientH / 4) {
                    _this.setState({
                        navIndex: 4
                    });
                } else {
        ...
        value: function navTab(index) {
            ...
            switch (index) {
                case 1:
                    window.scrollTo(0, navOne - clientH / 4);
                    break;
                case 2:
                    window.scrollTo(0, navTwo - clientH / 4);
                    break;
                case 3:
                    window.scrollTo(0, navThree - clientH / 4);
                    break;
                case 4:
                    window.scrollTo(0, navFour - clientH / 4);
                    break;
                default:
                    window.scrollTo(0, 0);
                    break;
